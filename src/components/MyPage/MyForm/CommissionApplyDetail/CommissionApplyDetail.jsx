                ...
                <table className="comApplyDetailRefund-table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>{application.submissionData.refundInfo.refund_bank}</td>
                        </tr>
                        <tr>
                            <td className="comApplyDetailTable-label">계좌번호</td>
                            <td>{application.submissionData.refundInfo.refund_account}</td>
                        </tr>
                        <tr>
                            <td className="comApplyDetailTable-label">예금주</td>
                            <td>{application.submissionData.refundInfo.refund_name}</td>
                        </tr>
                    </tbody>
                </table>
            </div>
