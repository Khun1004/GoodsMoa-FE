...
const ChatOther = () => {
  ...
  return (
    <div className="chat-other-container">
      <div className="otherChat-header">
        <div className="otherHeader-content">
          <img src={RoseImg} alt="Rose" className="rose-profile-image" />
          <h2><span>Rosé</span> 채팅방</h2>
        </div>
      </div>
      
      <div className="otherChat-messages">
        {messages.map((msg, index) => (
          <div 
            key={index} 
            className={`other-message-container ${msg.sender}`}
            onContextMenu={(e) => handleContextMenu(e, msg.id)}
          >
            {msg.sender === "me" && (
              <div className="other-sender-info">
                {shouldShowProfile(index) && (
                  <>
                    <img src={FelixImg} alt="Felix" className="other-profile-image" />
                    <span className="felix-name">Felix</span>
                  </>
                )}
              </div>
            )}
            <div className={`other-message ${msg.sender}`}>
            ...
            {msg.sender === "other" && (
              <div className="other-sender-info">
                {shouldShowProfile(index) && <img src={RoseImg} alt="Me" className="me-profile-image" />}
              </div>
            )}
          </div>
        ))}
      ...
      <div className="other-input-container">
        ...
        />
        <button onClick={sendReply} className="otherSend-button">
          전송
        </button>
        <button onClick={() => navigate("/chat-app")} className="main-button">
          메인 채팅방
        </button>
