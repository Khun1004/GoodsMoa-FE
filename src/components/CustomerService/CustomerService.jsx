        ...
        <div className="inquiry-container">
            {selectedInquiry ? (
                <div className="inquiry-detail-container">
                    <h2 className="inquiry-titlemin">제목: {selectedInquiry.title}</h2>
                    <p className="inquiry-content">내용: {selectedInquiry.content}</p>
                    {selectedInquiry.hasReply ? (
                        <div className="reply-section">
                            <h1 className="reply-titlemin">답변</h1>
                            <p className="reply-content">{selectedInquiry.replyContent}</p>
                        </div>
                    ) : (
                        <div className="reply-section">
                            <h1 className="reply-titlemin">답변</h1>
                            <p className="no-reply-message">아직 답변 등록이 없습니다</p>
                        </div>
                    )}
                    <button 
